package com.example.springmvc.entity.Tracking;
...
public class ClientsTracking {
    ...
    public ClientsTracking(int trackingId, Client client, Date date, float weight, float sleepHour, int stepCount, String notes) {
